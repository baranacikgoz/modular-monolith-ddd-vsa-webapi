skill:
  ...
  instructions: |
    ...
    4. **Check Localization Usage**:
       - Ensure `IStringLocalizer` or magic strings are NOT used for localized messages.
       - Verify usages of strongly-typed `IResxLocalizer` generated by `Aigamo.ResXGenerator`.

    5. **Report**: Output a list of violations.
