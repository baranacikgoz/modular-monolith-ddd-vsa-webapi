...
5. **Generate Output**: Create the `implementation_plan.md` artifact detailing all files to be modified, data structures, and the testing strategy.
6. **Seek Approval**: Wait for User approval via `notify_user` before proceeding to execution.
