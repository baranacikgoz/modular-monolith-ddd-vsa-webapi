...
5. **Generate Output**: Detail all files to be modified, data structures, the testing strategy, and the **Per-Module Telemetry** plan (ActivitySources/Meters)(telemetry if and only if provides valuable insights). The complete plan MUST be placed in the Pull Request description.
