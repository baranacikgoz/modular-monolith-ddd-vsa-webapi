...
## Corpus Check
- 514 files · ~73,420 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3162 nodes · 5349 edges · 351 communities (250 shown, 101 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e276297`
...
1. `Common.Application.Options` - 81 edges
2. `Result` - 77 edges
...
Cohesion: 0.11
Nodes (21): IEntityTypeConfiguration, AuditableEntity, DateTimeOffset, ApplicationUserId, DefaultIdType, DateTimeOffset, ApplicationUser, EntityTypeBuilder (+13 more)

### Community 2 - "Products Store & Audit Services"
Cohesion: 0.06
Nodes (25): Notifications.Application.Otp, IAM.Application.Tokens.Services, IAM.Application.Extensions, Common.Application.FeatureManagement, IAM.Endpoints.Otp, Common.InterModuleRequests.Contracts, IAM.Endpoints, IAM.Infrastructure.Tokens (+17 more)
...
Cohesion: 0.20
Nodes (13): AbstractValidator, Products.Endpoints.Products.v1.My.Update, BackgroundJobsOptions, BackgroundJobsOptionsValidator, CustomValidator, RequestBody, Request, RequestBody (+5 more)
...
Cohesion: 0.17
Nodes (11): Common.Application.AuditLog, Common.Infrastructure.Persistence.Extensions, Common.Application.Extensions, Products.Domain.Products, Products.Infrastructure.Telemetry, Products.Application.Persistence, Products.Domain.Stores, Common.Domain.ResultMonad (+3 more)
...
Cohesion: 0.14
Nodes (8): IAM.Domain.Captcha, IAM.Infrastructure.Captcha.Services, IAM.Infrastructure.Captcha, DateTime, ReCaptchaResponse, IConfiguration, IServiceCollection, Setup
...
Cohesion: 0.06
Nodes (21): Common.Infrastructure.Persistence, Common.Application.Persistence, IAM.Infrastructure.Persistence, IAM.Infrastructure.Persistence.Seeding, IAM.Domain.Identity, IDatabaseSeeder, CancellationToken, Task (+13 more)
...
Cohesion: 0.09
Nodes (21): Products.Domain.Products.DomainEvents.v1, AggregateRoot, IEnumerable, IReadOnlyCollection, List, DomainEvent, DateTimeOffset, DefaultIdType (+13 more)
...
Cohesion: 0.14
Nodes (10): AuditLogDto, DbContextExtensions, CancellationToken, DbSet, JsonSerializerOptions, Task, CancellationToken, RouteGroupBuilder (+2 more)
...
Cohesion: 0.12
Nodes (19): IntegrationEventHandlerBase, CancellationToken, ConsumeContext, DefaultIdType, ILogger, LoggerMessage, Task, TimeSpan (+11 more)
...
Cohesion: 0.14
Nodes (12): Common.Application.Validation, AuditLogOptions, AuditLogOptionsValidator, CorsOptions, CorsOptionsValidator, IReadOnlyList, HealthCheckOptions, HealthCheckOptionsValidator (+4 more)
...
Cohesion: 0.06
Nodes (24): Common.Infrastructure.Persistence.Auditing, Common.Infrastructure.Persistence.AuditLog, Common.Infrastructure.Persistence.DbContext, IHostedService, Setup, IServiceCollection, AuditLogRetentionJobRegistrar, CancellationToken (+16 more)
...
Cohesion: 0.11
Nodes (16): IAM.Endpoints.Tokens.VersionNeutral.Create, DbSet, IdentityRole, IdentityRoleClaim, IdentityUserClaim, IdentityUserLogin, IdentityUserRole, IdentityUserToken (+8 more)
...
Cohesion: 0.14
Nodes (13): Products.Endpoints.Probe.v1, Common.InterModuleRequests.IAM, IInterModuleRequest, GetSeedUserIdsRequest, GetSeedUserIdsResponse, CancellationToken, Task, GetSeedUserIdsRequestHandler (+5 more)
...
Cohesion: 0.21
Nodes (6): Outbox, Common.Infrastructure.Persistence.Outbox, Outbox.Persistence, Common.Application.Persistence.Outbox, IOutboxMessage, DateTimeOffset
...
Cohesion: 0.13
Nodes (11): PaginationResponse, PaginationQueryableExtensions, CancellationToken, Expression, Func, IQueryable, Task, CancellationToken (+3 more)
...
Cohesion: 0.10
Nodes (12): Common.Infrastructure.Modules, Host.Infrastructure, OtlpExportProtocol, IConfiguration, IServiceCollection, Setup, Assembly, IConfiguration (+4 more)

### Community 113 - "ReverseProxyOptions"
Cohesion: 0.27
Nodes (5): Result, Func, Task, CancellationToken, Task
...
Cohesion: 0.10
Nodes (15): Common.Application.JsonConverters, IAM.Infrastructure.Persistence.EntityConfigurations, Common.Infrastructure.Persistence.EntityConfigurations, Common.Infrastructure.Persistence.ValueConverters, DomainEventConverter, JsonSerializerOptions, EventConverter, JsonSerializerOptions (+7 more)
...
Cohesion: 0.29
Nodes (5): IRecurringBackgroundJobs, Action, Expression, Func, Task
...
Cohesion: 0.12
Nodes (13): Products.Endpoints.Stores.v1.My.AddProduct, Products.Endpoints.Stores.v1.AddProduct, decimal, int, Constants, RequestBody, Request, RequestBody (+5 more)
...
Cohesion: 0.50
Nodes (4): BackgroundJobsTelemetry, ActivitySource, Meter, string
...
Cohesion: 0.10
Nodes (23): Products.Endpoints.Stores.v1.AuditLog, Products.Endpoints.Stores.v1.My.AuditLog, Common.Application.Pagination, Products.Endpoints.Products.v1.AuditLog, PaginationRequest, PaginationRequestValidator, int, int (+15 more)
...
Cohesion: 0.12
Nodes (14): Outbox.Telemetry, Histogram, long, ObservableGauge, CancellationToken, ILogger, LoggerMessage, Task (+6 more)
...
### Community 225 - "DefaultResponsesOperationFilter"
Cohesion: 0.70
...
### Community 233 - "ModulesOptions.cs"
Cohesion: 0.67
...
Cohesion: 0.29
Nodes (6): RecurringJobOptions, RecurringBackgroundJobsService, Action, Expression, Func, Task
...
Cohesion: 0.08
Nodes (13): Common.Application.Search, Common.Infrastructure.Extensions, Common.Application.Options, Products.Infrastructure.Persistence.EntityConfigurations, RabbitMqOptions, HttpContextExtensions, HttpContext, IConfiguration (+5 more)
...
- **Why does `Common.Application.Options` connect `Response` to `Endpoint`, `Products Store & Audit Services`, `REPR Request Validators`, `BackgroundJobs Service (Hangfire)`, `IAM OTP Verify & Token Endpoint`, `Launch Settings`, `Authz Constants & Feature Flags`, `AutoMigrateMarker`, `SignalR Hub & Exception Middleware`, `Setup`, `Setup`, `StoreConfiguration`, `Endpoint`, `ApiVersionSet`, `Endpoint`, `Endpoint`, `Endpoint`, `CollectionExtensions`, `RequestValidator`, `Sync AI Settings Command`, `IAssemblyReference`, `Request.cs`, `RequestLoggingPathPostConfigure`, `Endpoint`, `IAssemblyReference`, `HttpContextExtensions`, `AuditLogRetentionJobRegistrar`, `Host.Swagger`, `OutboxCleanupSettings`, `Response`, `IAM`, `IntegrationEvent`, `ModulesOptions.cs`, `DomainEvent`, `AssemblyInfo`, `VerifyPhoneOtp`, `SignalROptions.cs`, `StringExtensions`, `OutboxMetricsJob`, `IRoleService`, `Setup`, `Setup`, `Setup`?**
  _High betweenness centrality (0.286) - this node is a cross-community bridge._
- **Why does `Common.Domain.StronglyTypedIds` connect `Functional Result Extensions` to `Endpoint`, `IAM User Identity & Auditing`, `Host Logging & Serilog Setup`, `Products Store & Audit Services`, `BackgroundJobs Service (Hangfire)`, `JwtOptions`, `Host Infrastructure Setup`, `SignalR Hub & Exception Middleware`, `Product Template Aggregate`, `CurrentUser`, `PermissionAuthorizationHandler`, `CustomRateLimitingOptions`, `EventDispatcher`, `Endpoint`, `Endpoint`, `Endpoint`, `DummyOtpService`, `Hangfire`, `IAssemblyReference`, `Endpoint`, `RabbitMqOptions`, `HttpContextExtensions`, `Setup.cs`, `IntegrationTestWebAppFactory`, `Setup`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `Common.Application.Auth` connect `BackgroundJobs Service (Hangfire)` to `CustomRoles`, `HangfireCustomAuthorizationFilter`, `Response`, `Products Store & Audit Services`, `HttpContextTargetingContextAccessor`, `Setup`, `IMiddleware`, `Functional Result Extensions`, `RabbitMqOptions`, `Host Infrastructure Setup`, `Response`, `Response`, `Response`, `Setup`, `PermissionAuthorizationHandler`?**
