...
## Corpus Check
- 513 files · ~73,244 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3152 nodes · 5335 edges · 340 communities (236 shown, 104 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f7ff6947`
...
1. `Common.Application.Options` - 80 edges
2. `Result` - 77 edges
...
## Communities (340 total, 104 thin omitted)
...
Cohesion: 0.12
Nodes (15): IAM.Application.Tokens.Services, IAM.Application.Extensions, IAM.Endpoints.Otp, IAM.Domain.Identity, Common.Infrastructure.Extensions, IAM.Endpoints.Tokens.VersionNeutral.Revoke, IAM.Infrastructure.Telemetry, IAM.Application.Persistence (+7 more)
...
Cohesion: 0.17
Nodes (11): Guid, DateTimeOffset, RefreshToken, DateTimeOffset, Guid, IReadOnlyCollection, List, Session (+3 more)
...
Cohesion: 0.26
Nodes (11): AbstractValidator, Products.Endpoints.Products.v1.My.Update, CustomValidator, RequestBody, Request, RequestBody, RequestBodyValidator, RequestValidator (+3 more)
...
Cohesion: 0.11
Nodes (21): IAM.Endpoints.Users.VersionNeutral.SelfRegister, accessToken, DateTimeOffset, expiresAt, ICollection, refreshTokenBytes, ITokenService, CancellationToken (+13 more)
...
Cohesion: 0.08
Nodes (11): Products.Domain.Products.DomainEvents.v1, Common.Domain.StronglyTypedIds, IAM.Domain.Identity.DomainEvents.v1, Common.Domain.Events, IAM.Domain.Identity.Sessions, IAM.Endpoints.Users.VersionNeutral.Me.Get, Common.Domain.Entities, Common.Domain.Aggregates (+3 more)

### Community 16 - "Launch Settings"
Cohesion: 0.08
Nodes (14): Products.Infrastructure.Persistence.Seeding, Common.Application.FeatureManagement, Products.Endpoints.Probe.v1, IAM.Domain.Captcha, Common.InterModuleRequests.IAM, Common.InterModuleRequests.Contracts, IAM.Infrastructure.Captcha.Services, IAM.Application.Captcha.Services (+6 more)

### Community 17 - "Module Installers (IModule)"
Cohesion: 0.10
Nodes (16): Common.Application.Persistence.Outbox, DbContext, IOutboxMessage, DateTimeOffset, OutboxMessage, DateTimeOffset, TimeSpan, IOutboxDbContext (+8 more)
...
Cohesion: 0.09
Nodes (17): IAM.Endpoints.Users.VersionNeutral.CheckRegistration, IAM.Endpoints.Common.Validations, IResxLocalizer, IRuleBuilder, IRuleBuilderOptions, CommonValidations, IResxLocalizer, IRuleBuilder (+9 more)
...
Cohesion: 0.13
Nodes (13): IAM.Endpoints.Tokens.VersionNeutral.Refresh, CancellationToken, HttpContext, ILogger, LoggerMessage, RouteGroupBuilder, Task, TimeProvider (+5 more)
...
Cohesion: 0.10
Nodes (17): Products.Endpoints.Products.v1.My.Get, Products.Endpoints.ProductTemplates.v1.Search, Products.Endpoints.Products.v1.Search, Common.Application.DTOs, Products.Endpoints.Stores.v1.Get, Products.Endpoints.ProductTemplates.v1.Get, Products.Endpoints.Products.v1.Get, Products.Endpoints.Stores.v1.My.Get (+9 more)
...
Cohesion: 0.17
Nodes (7): Products.Endpoints.Stores, RouteGroupBuilder, Setup, CancellationToken, RouteGroupBuilder, Task, Endpoint
...
### Community 44 - "Seeder"
Cohesion: 0.15
Nodes (10): ISearchLocalized, Product, IReadOnlyCollection, List, Store, EntityTypeBuilder, ProductConfiguration, DbSet (+2 more)
...
Cohesion: 0.14
Nodes (11): Products.Endpoints.Stores.v1.My.AddProduct, Common.Application.JsonConverters, Request, RequestValidator, CancellationToken, RouteGroupBuilder, Task, Endpoint (+3 more)
...
Cohesion: 0.10
Nodes (14): Notifications.Infrastructure.Telemetry, Notifications.Infrastructure.Hubs, Notifications.Application.Hubs, Notifications.Infrastructure, IConfiguration, IServiceCollection, Setup, IAssemblyReference (+6 more)
...
Cohesion: 0.08
Nodes (27): IntegrationEventHandlerBase, CancellationToken, ConsumeContext, DefaultIdType, ILogger, LoggerMessage, Task, TimeSpan (+19 more)
...
Cohesion: 0.13
Nodes (13): Products.Endpoints.Stores.v1.My.Update, Common.Application.Validation, CaptchaOptions, CaptchaOptionsValidator, ModulesOptions, ModulesOptionsValidator, IReadOnlyList, OpenApiOptions (+5 more)
...
Cohesion: 0.10
Nodes (17): ICoreModule, BackgroundJobsModule, IApplicationBuilder, IConfiguration, IEndpointRouteBuilder, IEnumerable, IServiceCollection, Action (+9 more)
...
Cohesion: 0.16
Nodes (11): IAM.Endpoints.Tokens.VersionNeutral.Create, CancellationToken, HttpContext, IOptions, Task, TimeProvider, Guid, Request (+3 more)
...
Cohesion: 0.17
Nodes (10): Products.Endpoints.Stores.v1.AuditLog, PaginationRequest, PaginationQueryableExtensions, CancellationToken, Expression, Func, IQueryable, Task (+2 more)
...
Cohesion: 0.25
Nodes (8): DbSet, IdentityRole, IdentityRoleClaim, IdentityUserClaim, IdentityUserLogin, IdentityUserRole, IdentityUserToken, IIAMDbContext
...
Cohesion: 0.22
Nodes (7): CancellationToken, RouteGroupBuilder, Task, Endpoint, DateOnly, IReadOnlyCollection, Response
...
Cohesion: 0.24
Nodes (9): OtpVerificationFailureReason, VerifyPhoneOtpRequest, VerifyPhoneOtpResponse, VerifyPhoneOtpResponseExtensions, int, InProcessVerifyOtpClient, CancellationToken, Task (+1 more)
...
Cohesion: 0.40
Nodes (4): BaseDbContext, CancellationToken, DbSet, Task
...
### Community 152 - "Setup"
Cohesion: 0.25
Nodes (6): AuditableEntityConfiguration, EntityTypeBuilder, EntityTypeBuilder, RefreshTokenConfig, EntityTypeBuilder, StoreConfiguration
...
Cohesion: 0.11
Nodes (15): Common.Application.ModelBinders, IAM.Endpoints.Tokens.VersionNeutral.Sessions.Revoke, Products.Endpoints.ProductTemplates.v1.Activate, IModelBinder, ModelBindingContext, StronglyTypedIdBinder, Task, Request (+7 more)
...
### Community 160 - "Setup"
Cohesion: 0.16
Nodes (10): Outbox, Common.Infrastructure.Persistence.Outbox, Outbox.Persistence, Outbox.Telemetry, CancellationToken, ILogger, LoggerMessage, Task (+2 more)
...
### Community 166 - "Setup"
Cohesion: 0.09
Nodes (14): IAM.Endpoints, IAM.Endpoints.Otp.VersionNeutral, IAM.Infrastructure.Captcha, IAM.Endpoints.Tokens.VersionNeutral, IAM.Endpoints.Users.VersionNeutral, IAssemblyReference, RouteGroupBuilder, Setup (+6 more)
...
Cohesion: 0.67
Nodes (3): IAM.Endpoints.Otp.VersionNeutral.SendForLogin, Request, RequestValidator
...
Cohesion: 0.16
Nodes (10): Products.Endpoints.Products.v1.AuditLog, decimal, PaginationRequestValidator, int, int, Constants, Request, RequestValidator (+2 more)
...
Cohesion: 0.67
Nodes (3): IAM.Endpoints.Otp.VersionNeutral.SendForRegistration, Request, RequestValidator
...
Cohesion: 0.13
Nodes (12): Histogram, long, ObservableGauge, CancellationToken, ILogger, LoggerMessage, Task, ActivitySource (+4 more)
...
Cohesion: 0.08
Nodes (18): DbSet, IProductsDbContext, CancellationToken, RouteGroupBuilder, Task, Endpoint, CancellationToken, RouteGroupBuilder (+10 more)
...
## Knowledge Gaps
- **365 isolated node(s):** `check-csproj-refs.sh script`, `pre-commit-guard.sh script`, `docker-compose`, `TURKISH_NAMES`, `JSON_HEADERS` (+360 more)
...
- **Why does `Common.Application.Options` connect `StringExtensions` to `Endpoint`, `Products Store & Audit Services`, `Response`, `BackgroundJobs Service (Hangfire)`, `IAM OTP Verify & Token Endpoint`, `Functional Result Extensions`, `Launch Settings`, `Host Infrastructure Setup`, `AutoMigrateMarker`, `EF Core DbContexts`, `Endpoint`, `Setup`, `StoreConfiguration`, `Setup`, `Endpoint`, `ApiVersionSet`, `Endpoint`, `Endpoint`, `Endpoint`, `Hangfire`, `Sync AI Settings Command`, `Request.cs`, `RequestLoggingPathPostConfigure`, `Endpoint`, `HttpContextExtensions`, `AuditLogRetentionJobRegistrar`, `RequestValidator`, `ConfigurationManager`, `HostTestFactory`, `Response`, `IAM`, `IntegrationEvent`, `IdentityResultExtensions`, `AccessTokenDto`, `DomainEvent`, `VerifyPhoneOtp`, `IRoleService`, `Setup`?**
  _High betweenness centrality (0.293) - this node is a cross-community bridge._
- **Why does `Common.Domain.StronglyTypedIds` connect `Functional Result Extensions` to `Host Logging & Serilog Setup`, `IAM User Identity & Auditing`, `Endpoint`, `Products Store & Audit Services`, `BackgroundJobs Service (Hangfire)`, `JwtOptions`, `Launch Settings`, `OtpOptions`, `Host Infrastructure Setup`, `Endpoint`, `CurrentUser`, `PermissionAuthorizationHandler`, `CustomRateLimitingOptions`, `Endpoint`, `Endpoint`, `DummyOtpService`, `decimal`, `Hangfire`, `OutboxModule`, `Endpoint`, `OutboxCleanupJob`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Common.Application.Auth` connect `BackgroundJobs Service (Hangfire)` to `CustomRoles`, `HangfireCustomAuthorizationFilter`, `Response`, `Setup`, `HttpContextTargetingContextAccessor`, `Products Store & Audit Services`, `IMiddleware`, `Functional Result Extensions`, `Launch Settings`, `Host Infrastructure Setup`, `Response`, `Response`, `Setup`, `Endpoint`, `PermissionAuthorizationHandler`?**
