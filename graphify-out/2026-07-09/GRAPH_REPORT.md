# Graph Report - modular-monolith-ddd-vsa-webapi  (2026-07-09)

## Corpus Check
- 496 files · ~70,525 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3037 nodes · 5046 edges · 349 communities (249 shown, 100 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 63 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2beec37f`
...
- Response
- Response
- V1ProductDescriptionUpdatedDomainEvent
...
1. `Common.Application.Options` - 75 edges
2. `Result` - 74 edges
3. `Common.Domain.ResultMonad` - 60 edges
4. `Common.Domain.StronglyTypedIds` - 59 edges
5. `Common.Application.Auth` - 56 edges
6. `CustomValidator` - 54 edges
7. `ApplicationUserId` - 48 edges
8. `Common.Application.Validation` - 47 edges
9. `Common.Application.Extensions` - 44 edges
10. `Common.Domain.Events` - 38 edges
...
## Communities (349 total, 100 thin omitted)

### Community 0 - "Host Logging & Serilog Setup"
Cohesion: 0.07
Nodes (25): JsonConverter, StronglyTypedIdListReadOnlyJsonConverter, IReadOnlyList, JsonSerializerOptions, Type, Utf8JsonReader, Utf8JsonWriter, StronglyTypedIdReadOnlyJsonConverter (+17 more)
...
Cohesion: 0.09
Nodes (19): Notifications.Application.Otp, IAM.Application.Tokens.Services, IAM.Endpoints.Otp, Common.InterModuleRequests.Contracts, IAM.Domain.Identity, Common.Infrastructure.Extensions, Notifications.Infrastructure.InterModuleRequestHandlers, IAM.Endpoints.Tokens.VersionNeutral.Revoke (+11 more)
...
Cohesion: 0.18
Nodes (7): IAM.Infrastructure.Persistence, IAM.Endpoints, IAM.Infrastructure.Identity, IAM.Infrastructure.Captcha, IAssemblyReference, IServiceCollection, Setup

### Community 6 - "Domain Event Handling & Outbox Collect"
Cohesion: 0.29
Nodes (5): IdentityUser, DateOnly, DateTimeOffset, ApplicationUser, Uri
...
Cohesion: 0.16
Nodes (15): accessToken, DateTimeOffset, expiresAt, ICollection, refreshTokenBytes, ITokenService, CancellationToken, IFeatureManager (+7 more)
...
Cohesion: 0.24
Nodes (7): Common.Domain.StronglyTypedIds, IAM.Domain.Identity.DomainEvents.v1, Common.Domain.Events, Common.Domain.Aggregates, V1RefreshTokenRevokedDomainEvent, V1RefreshTokenUpdatedDomainEvent, V1UserImageUrlUpdatedDomainEvent

### Community 16 - "Launch Settings"
Cohesion: 0.11
Nodes (9): IAM.Application.Extensions, Common.Application.FeatureManagement, IAM.Domain.Captcha, IAM.Infrastructure.Captcha.Services, IAM.Application.Captcha.Services, Common.Domain.ResultMonad, IAM.Domain.Errors, DateTime (+1 more)
...
Cohesion: 0.14
Nodes (6): Products.Infrastructure.Persistence, Products.Infrastructure.Persistence.Seeding, Common.Application.Persistence, IAM.Infrastructure.Persistence.Seeding, Common.InterModuleRequests.IAM, Common.Infrastructure.Persistence.DbContext
...
Cohesion: 0.16
Nodes (10): IAM.Endpoints.Tokens.VersionNeutral.Refresh, CancellationToken, RouteGroupBuilder, Task, TimeProvider, Endpoint, Request, RequestValidator (+2 more)
...
Cohesion: 0.08
Nodes (19): AuditLogDto, DbSet, IProductsDbContext, CancellationToken, RouteGroupBuilder, Task, Endpoint, CancellationToken (+11 more)
...
Cohesion: 0.10
Nodes (18): Products.Domain.Products.DomainEvents.v1, AggregateRoot, IEnumerable, IReadOnlyCollection, List, IAggregateRoot, IEnumerable, IReadOnlyCollection (+10 more)
...
Cohesion: 0.07
Nodes (23): IRateLimiterPolicy, CancellationToken, Func, HttpContext, OnRejectedContext, RateLimitPartition, ValueTask, RegisterRateLimitingPolicy (+15 more)
...
Cohesion: 0.20
Nodes (5): Notifications.Infrastructure.Telemetry, Notifications.Infrastructure.Hubs, Notifications.Infrastructure, NotificationGroupName, IAssemblyReference
...
Cohesion: 0.09
Nodes (15): Common.Infrastructure.Auth.Services, Common.Infrastructure.Auth, FrozenDictionary, IReadOnlySet, CustomPermissions, HashSet, IEnumerable, CurrentUser (+7 more)

### Community 67 - "AuthenticateResult"
Cohesion: 0.22
Nodes (8): AuthenticateResult, AuthenticationHandler, AuthenticationProperties, AuthenticationSchemeOptions, Guid, TestAuthHandler, string, Task
...
Cohesion: 0.13
Nodes (12): UserRegisteredIntegrationEvent, CancellationToken, ILogger, LoggerMessage, Task, UserRegisteredSignalRHandler, CancellationToken, ILogger (+4 more)
...
Cohesion: 0.11
Nodes (16): Products.Endpoints.Products.v1.Update, Products.Endpoints.Stores.v1.RemoveProduct, Products.Endpoints.Products.v1.AuditLog, ProductId, Request, RequestValidator, Request, RequestValidator (+8 more)
...
Cohesion: 0.10
Nodes (14): Common.IntegrationEvents, Notifications.Application.IntegrationEventHandlers, IAM.Application.Users.DomainEventHandlers.v1, Common.Application.EventBus, Lock, IIntegrationEventOutbox, IntegrationEventOutbox, List (+6 more)
...
Cohesion: 0.15
Nodes (11): Common.Application.Validation, BackgroundJobsOptions, BackgroundJobsOptionsValidator, CaptchaOptions, CaptchaOptionsValidator, DatabaseOptions, DatabaseOptionsValidator, JwtOptions (+3 more)
...
Cohesion: 0.12
Nodes (14): IAM.Endpoints.Tokens.VersionNeutral.Create, DbSet, IdentityRole, IdentityRoleClaim, IdentityUserClaim, IdentityUserLogin, IdentityUserRole, IdentityUserToken (+6 more)
...
Cohesion: 0.16
Nodes (8): Notifications.Infrastructure.Sms, Notifications.Application, IAssemblyReference, ISmsService, Task, DummySmsService, IServiceCollection, Setup
...
Cohesion: 0.07
Nodes (31): IdentityDbContext, EventDispatcher, ActivitySource, CancellationToken, ILogger, LoggerMessage, Task, BaseDbContext (+23 more)
...
Cohesion: 0.40
Nodes (4): ITargetingContextAccessor, HttpContextTargetingContextAccessor, ValueTask, TargetingContext
...
Cohesion: 0.50
Nodes (3): PaginationRequest, Request, RequestValidator
...
Cohesion: 0.25
Nodes (6): IReadOnlyList, IntegrationEvent, DateTimeOffset, DefaultIdType, ProductCreatedIntegrationEvent, StoreCreatedIntegrationEvent
...
### Community 122 - "Setup"
Cohesion: 0.17
Nodes (6): Notifications.Infrastructure.Otp, string, DummyOtpService, OtpService, IServiceCollection, Setup
...
Cohesion: 0.25
Nodes (8): LoadAll, Names, Exception, IConfiguration, ILogger, IReadOnlyList, LoggerMessage, Setup
...
Cohesion: 0.11
Nodes (11): Common.Infrastructure.Persistence, Common.Infrastructure.Localization, Common.Infrastructure.EventBus, Common.Domain.Entities, IAM.Infrastructure.Persistence.EntityConfigurations, Common.Infrastructure.FeatureManagement, Common.Infrastructure.Persistence.EntityConfigurations, Common.Infrastructure.Persistence.ValueConverters (+3 more)
...
Cohesion: 0.31
Nodes (8): OtpVerificationFailureReason, VerifyPhoneOtpRequest, VerifyPhoneOtpResponse, int, InProcessVerifyOtpClient, CancellationToken, Task, VerifyPhoneOtpRequestHandler
...
Cohesion: 0.24
Nodes (5): Common.Infrastructure.Persistence.Outbox, Outbox.Persistence, Common.Application.Persistence.Outbox, IOutboxMessage, DateTimeOffset
...
Cohesion: 0.10
Nodes (15): IInterModuleRequestClient, CancellationToken, Task, CancellationToken, Task, CancellationToken, IFeatureManager, RouteGroupBuilder (+7 more)
...
Cohesion: 0.08
Nodes (17): IFusionCache, ICurrentUser, ICollection, CancellationToken, HttpContext, IOptions, RouteGroupBuilder, Task (+9 more)
...
Cohesion: 0.12
Nodes (14): Common.Application.ModelBinders, Products.Endpoints.ProductTemplates.v1.Activate, IModelBinder, ModelBindingContext, StronglyTypedIdBinder, Task, Request, RequestValidator (+6 more)
...
Cohesion: 0.29
Nodes (5): BackgroundJobs.Telemetry, BackgroundJobsTelemetry, ActivitySource, Meter, string
...
Cohesion: 0.33
Nodes (5): decimal, int, Constants, Request, RequestValidator
...
Cohesion: 0.17
Nodes (10): Histogram, long, ObservableGauge, CancellationToken, Task, ActivitySource, Counter, Meter (+2 more)
...
Cohesion: 0.19
Nodes (8): AuditableEntity, DateTimeOffset, AuditLogEntry, DefaultIdType, IAuditableEntity, DateTimeOffset, AuditLogEntryConfiguration, EntityTypeBuilder
...
### Community 198 - "check-csproj-refs.sh"
Cohesion: 0.33
...
Cohesion: 0.20
Nodes (6): IAM.Endpoints.Users.VersionNeutral.SelfRegister, Common.Domain.Extensions, SearchValues, StringExtensions, Request, RequestValidator
...
### Community 240 - "PaginationRequest"
Cohesion: 0.67
Nodes (3): Products.Endpoints.Stores.v1.My.Update, Request, RequestValidator

### Community 241 - "PaginationResponse"
Cohesion: 0.13
Nodes (10): Common.Application.Search, Common.Endpoints.Versioning, Products.Infrastructure.RateLimiting, Common.Application.Options, Products.Endpoints, Common.Application.Pagination, RabbitMqOptions, IAssemblyReference (+2 more)
...
### Community 252 - "Response"
Cohesion: 0.50
Nodes (3): IConfiguration, IServiceCollection, Setup

### Community 444 - "Host.Swagger"
Cohesion: 0.40
...
- **Why does `Common.Application.Options` connect `PaginationResponse` to `Endpoint`, `Products Store & Audit Services`, `Response`, `Cross-Module Comm & Arch Audit Skills`, `Setup`, `V1ProductDescriptionUpdatedDomainEvent`, `Launch Settings`, `SignalR Hub & Exception Middleware`, `Setup`, `EF Core DbContexts`, `Setup`, `StoreConfiguration`, `Endpoint`, `Endpoint`, `Endpoint`, `Endpoint`, `Endpoint`, `Host.Swagger`, `Sync AI Settings Command`, `check-csproj-refs.sh`, `OutboxModule`, `ApiVersionDescription`, `IAssemblyReference`, `RequestLoggingPathPostConfigure`, `Endpoint`, `HttpContextExtensions`, `AuditLogRetentionJobRegistrar`, `RequestValidator`, `Response`, `IAM`, `IntegrationEvent`, `DomainEvent`, `ProductsModule`, `Setup`, `StringExtensions`, `OutboxMetricsJob`, `IRoleService`, `Response`, `Setup`, `Response`, `Setup`?**
  _High betweenness centrality (0.260) - this node is a cross-community bridge._
- **Why does `Common.Application.Auth` connect `BackgroundJobs Service (Hangfire)` to `Endpoint`, `CustomRoles`, `HangfireCustomAuthorizationFilter`, `Response`, `Setup`, `Products Store & Audit Services`, `Setup`, `IMiddleware`, `ProductsModule`, `Launch Settings`, `PaginationResponse`, `Host Infrastructure Setup`, `Response`, `Response`, `AutoMigrateMarker`, `Response`, `PermissionAuthorizationHandler`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `Common.Domain.StronglyTypedIds` connect `Functional Result Extensions` to `Host Logging & Serilog Setup`, `IAM User Identity & Auditing`, `Endpoint`, `Products Store & Audit Services`, `Cross-Module Comm & Arch Audit Skills`, `Setup`, `AuditLogOptions`, `JwtOptions`, `OtpOptions`, `Host Infrastructure Setup`, `AutoMigrateMarker`, `SignalR Hub & Exception Middleware`, `Product Template Aggregate`, `CurrentUser`, `PermissionAuthorizationHandler`, `CustomRateLimitingOptions`, `ISearchLocalized`, `Endpoint`, `Endpoint`, `Endpoint`, `Hangfire`, `CustomRoles`, `IAssemblyReference`, `OutboxModule`, `IAssemblyReference`, `Endpoint`, `IntegrationTestWebAppFactory`, `IOpenApiSchema`, `IdentityResultExtensions`, `ProductsModule`, `RequestBody`?**
