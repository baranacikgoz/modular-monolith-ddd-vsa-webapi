...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "Products"."__EFMigrationsHistory" WHERE "MigrationId" = '20260719143914_AuditLogCreatedOnIndex') THEN
    CREATE INDEX "IX_AuditLog_CreatedOn" ON "Products"."AuditLog" ("CreatedOn");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "Products"."__EFMigrationsHistory" WHERE "MigrationId" = '20260719143914_AuditLogCreatedOnIndex') THEN
    INSERT INTO "Products"."__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260719143914_AuditLogCreatedOnIndex', '10.0.9');
    END IF;
END $EF$;
COMMIT;
