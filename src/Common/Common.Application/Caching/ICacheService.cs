...
public interface ICacheService
{
    ...
    Task SetAsync<T>(string key, T value, IEnumerable<string>? tags = null, TimeSpan? absoluteExpirationRelativeToNow = null, CancellationToken cancellationToken = default);
