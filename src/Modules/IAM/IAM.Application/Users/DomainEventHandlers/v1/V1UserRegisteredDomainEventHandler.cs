...
{
    protected override async Task HandleAsync(ConsumeContext<V1UserRegisteredDomainEvent> context, V1UserRegisteredDomainEvent @event, CancellationToken cancellationToken)
    {
