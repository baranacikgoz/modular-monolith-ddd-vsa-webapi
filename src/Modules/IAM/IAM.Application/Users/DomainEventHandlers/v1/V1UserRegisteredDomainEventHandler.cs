...
public class V1UserRegisteredDomainEventHandler(IEventBus eventbus, IFusionCache cache, IOptions<CachingOptions> cachingOptions, ILogger<V1UserRegisteredDomainEventHandler> logger)
