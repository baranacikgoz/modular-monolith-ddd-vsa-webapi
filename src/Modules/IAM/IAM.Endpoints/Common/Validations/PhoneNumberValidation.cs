...
public static partial class CommonValidations
{
        ...
        IStringLocalizer<ResxLocalizer> localizer)
    {
        return ruleBuilder
            ...
            .WithMessage(localizer["Telefon numarası, alan kodu dahil {0} karakter olmalıdır.",
            ...
            .WithMessage(
                localizer["Şuanda sadece Türkiye numaraları desteklenmektedir. Numaranız 90 ile başlamalıdır."]);
    }
}
