...
public sealed class RequestValidator : CustomValidator<Request>
{
    public RequestValidator(IStringLocalizer<ResxLocalizer> localizer)
    {
        ...
        RuleFor(x => x.Name)
            ...
            .WithMessage(localizer["Register.Name.MaxLength {0}", Constants.NameMaxLength])
        ...
        RuleFor(x => x.LastName)
            ...
            .WithMessage(localizer["Register.LastName.MaxLength {0}", Constants.LastNameMaxLength])
        ...
        RuleFor(x => x.NationalIdentityNumber)
            ...
            .WithMessage(
                localizer["Register.NationalIdentityNumber.Length {0}", Constants.NationalIdentityNumberLength])
