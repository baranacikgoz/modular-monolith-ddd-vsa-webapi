...
{
    private sealed class EmailRateLimitingPolicy(IOptions<CustomRateLimitingOptions> rateLimitingOptionsProvider)
        : IRateLimiterPolicy<string>
    {
        ...
        public RateLimitPartition<string> GetPartition(HttpContext httpContext)
        {
            ...
            return RateLimitPartitions.FixedWindow(
                httpContext, Constants.Email, partitionKey, rateLimitingOptionsProvider.Value.Email);
        }
    }
}
