...
{
    private sealed class OtpVerifyRateLimitingPolicy(IOptions<CustomRateLimitingOptions> rateLimitingOptionsProvider)
        : IRateLimiterPolicy<string>
    {
        ...
        public RateLimitPartition<string> GetPartition(HttpContext httpContext)
        {
            ...
            return RateLimitPartitions.FixedWindow(
                httpContext, Constants.OtpVerify, partitionKey, rateLimitingOptionsProvider.Value.OtpVerify);
        }
    }
}
