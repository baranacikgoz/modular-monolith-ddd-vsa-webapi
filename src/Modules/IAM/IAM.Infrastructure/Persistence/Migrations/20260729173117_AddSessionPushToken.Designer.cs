...
namespace IAM.Infrastructure.Migrations
{
    ...
    [Migration("20260729173117_AddSessionPushToken")]
    partial class AddSessionPushToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IAM.Domain.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        ...
                        .HasComputedColumnSql("setweight(to_tsvector('simple_unaccent', coalesce(\"FullName\",'')), 'A')", true);
            ...
            modelBuilder.Entity("IAM.Domain.Identity.Sessions.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IAM.Domain.Identity.Sessions.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IAM.Domain.Identity.Sessions.RefreshToken", b =>
                {
                    b.HasOne("IAM.Domain.Identity.Sessions.Session", null)
