...
namespace Outbox.Migrations
{
    ...
    [Migration("20260521130048_AddNextRetryAtToOutboxMessages")]
    partial class AddNextRetryAtToOutboxMessages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Common.Application.Persistence.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.HasIndex("IsProcessed", "FailedOn", "NextRetryAt", "CreatedOn");
