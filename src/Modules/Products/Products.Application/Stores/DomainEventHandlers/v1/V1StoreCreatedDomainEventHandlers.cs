...
{
    public class StoreCreatedIntegrationEventPublishingHandler(IEventBus eventBus) : EventHandlerBase<V1StoreCreatedDomainEvent>
    {
    ...
    {
        protected override Task HandleAsync(ConsumeContext<V1StoreCreatedDomainEvent> context, V1StoreCreatedDomainEvent @event, CancellationToken cancellationToken)
        {
