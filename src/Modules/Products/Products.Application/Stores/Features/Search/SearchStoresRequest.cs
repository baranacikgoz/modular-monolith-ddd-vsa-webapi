...
public sealed record SearchStoresRequest : PaginationRequest<Store>, IQuery<PaginationResponse<StoreResponse>>
{
...
public sealed class SearchStoresRequestValidator : PaginationRequestValidator<SearchStoresRequest, Store>
{
    public SearchStoresRequestValidator(IStringLocalizer<ResxLocalizer> localizer) : base(localizer)
    {
        RuleFor(x => x.Name)
