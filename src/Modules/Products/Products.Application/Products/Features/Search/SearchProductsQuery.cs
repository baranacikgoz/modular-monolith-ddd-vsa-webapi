...
public sealed record SearchProductsQuery : PaginationQuery, IQuery<PaginationResult<ProductDto>>
{
...
public sealed class SearchProductsQueryValidator : PaginationQueryValidator<SearchProductsQuery>
{
