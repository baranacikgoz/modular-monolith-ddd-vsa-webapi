...
{
    [Fact]
    public void Boot_WithTestModuleOverride_ShouldOnlyLoadTargetModules()
    {
        // Arrange
        var targetModule = "IAM";
        using var factory = new HostTestFactory().WithModules(targetModule);
    ...
    [Fact]
    public void Boot_ModulesAreResolvedInPriorityOrder()
    {
         // Arrange - IAM (2) and Notifications (3)
         using var factory = new HostTestFactory().WithModules("Notifications,IAM");
